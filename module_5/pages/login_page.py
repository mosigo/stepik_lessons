...
class LoginPage(BasePage):
    ...
    def should_be_login_url(self):
        assert 'login' in self.browser.current_url, 'Текущая страница не является страницей логина'

    def should_be_login_form(self):
        assert self.is_element_present(*LoginPageLocators.LOGIN_FORM), "На странице нет формы логина"

    def should_be_register_form(self):
        assert self.is_element_present(*LoginPageLocators.REGISTER_FORM), "На странице нет формы регитрации"